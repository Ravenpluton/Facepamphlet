...
public interface FacePamphletConstants2 {
	...
	// font for first welcome label
	public static final String WELCOME_FONT = "HelvaticaNeue-10-bold";
	 ...
	 *  the bottom of the occupation and the top of the Status component 
	 *  in the profile */		
	public static final double STATUS_MARGIN = 5;

	/** The number of vertical pixels in the vertical margin between 
	 *  the bottom of the gender and the top of the occupation component 
	 *  in the profile */	
	public static final double OCCUPATION_MARGIN = 5;
	
	/** The number of vertical pixels in the vertical margin between 
	 *  the bottom of the Image and the top of the gender component 
	 *  in the profile */
	public static final double GENDER_MARGIN = 20;
	
	// file where all the criminal photo names and criminal names are
	public static final String CRIMINALS_FILE = "criminalList.txt";
	
	// criminals' pictures' top margin
	public static final double PICTURES_TOP_MARGIN = TOP_MARGIN + 10;
}
